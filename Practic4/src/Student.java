...
class CompareFilmTitle implements Comparator<Student> {
    @Override
...
class CompareFilmReleaseYearFromTheOldest implements Comparator<Student> {
    @Override
    public int compare(Student student1, Student student2) {
...
class CompareFilmReleaseYearFromTheYoungest implements Comparator<Student> {
    @Override
    public int compare(Student student1, Student student2) {
